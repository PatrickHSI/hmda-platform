...
case class LarPartOne2019(id: Int = 0,
                          lei: String = "",
                          uli: String = "",
...
case class LarPartThree2019(otherNativeRaceApplicant: String = "",
...
case class LarPartFour2019(purchaserType: Int = 0,
                           rateSpread: String = "",
                           hoepaStatus: Int = 0,
                           lienStatus: Int = 0,
...
case class LarPartFive2019(discountPoints: String = "",
...
case class LarPartSix2019(payable: Int = 0,
                          nmls: String = "",
                          aus1: String = "",
                          aus2: String = "",
                          aus3: String = "",
...
case class LarPartSeven2019(conformingLoanLimit: String = "",
...
case class LarEntityImpl2019(larPartOne: LarPartOne2019,
                             ...
                             larPartThree: LarPartThree2019,
                             larPartFour: LarPartFour2019,
                             larPartFive: LarPartFive2019,
                             larPartSix: LarPartSix2019,
                             larPartSeven: LarPartSeven2019) {
