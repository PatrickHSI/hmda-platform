...
case class LarPartOne2018(id: Int = 0,
                          lei: String = "",
                          uli: String = "",
...
case class LarPartTwo2018(ethnicityApplicant1: String = "",
...
case class LarPartThree2018(otherNativeRaceApplicant: String = "",
...
case class LarPartFour2018(purchaserType: Int = 0,
                           rateSpread: String = "",
                           hoepaStatus: Int = 0,
                           lienStatus: Int = 0,
...
case class LarPartFive2018(discountPoints: String = "",
...
case class LarPartSix2018(payable: Int = 0,
                          nmls: String = "",
                          aus1: String = "",
                          aus2: String = "",
                          aus3: String = "",
...
case class LarEntityImpl2018(larPartOne: LarPartOne2018,
                             larPartTwo: LarPartTwo2018,
                             larPartThree: LarPartThree2018,
                             larPartFour: LarPartFour2018,
                             larPartFive: LarPartFive2018,
                             larPartSix: LarPartSix2018) {
